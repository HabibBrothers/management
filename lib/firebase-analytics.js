...
function d() {
  return new Promise((e, t) => {
    try {
      ...
      (i.onsuccess = () => {
        i.result.close(),
          n || self.indexedDB.deleteDatabase(a),
          e(!0);
      }),
        (i.onupgradeneeded = () => {
          n = !1;
...
async function oe(e) {
  ...
  const n = await re(e.appConfig, (n) => {
    const a = (function (e) {
        return le(e || { fid: U(), registrationStatus: 0 });
      })(n),
      i = (function (e, t) {
...
async function se(e) {
  ...
  if (0 === t.registrationStatus) {
    const { installationEntry: t, registrationPromise: n } = await oe(
      e
    );
    return n || t;
  }
...
async function ue({ appConfig: e, heartbeatServiceProvider: t }, n) {
  ...
  const o = {
      installation: { sdkVersion: "w:0.5.12", appId: e.appId },
    },
...
function fe(e) {
  return re(e, (e) => {
    ...
    const t = e.authToken;
    return 1 === (n = t).requestStatus &&
      n.requestTime + 1e4 < Date.now()
...
async function De(e, t = Ee, n) {
  ...
  return (
    ...
    Se({ appId: a, apiKey: i, measurementId: r }, o, s, t)
  );
}
async function Se(
  e,
  ...
  var r, o;
  const { appId: s, measurementId: c } = e;
  try {
    await (function (e, t) {
  ...
  try {
    ...
    return i.deleteThrottleMetadata(s), t;
  } catch (t) {
    const r = t;
    if (
      !(function (e) {
    ...
    const l =
        503 ===
        Number(
          null === (o = null == r ? void 0 : r.customData) ||
            void 0 === o
            ? void 0
            : o.httpStatus
        )
...
async function $e(e, t, n, a, i, r, o) {
  ...
  const l = (async function () {
      ...
      if (!u())
        return (
          ye.warn(
            be.create("indexeddb-unavailable", {
              errorInfo:
  ...
  (function () {
    ...
    for (const t of Object.values(e))
      if (t.src && t.src.includes(we)) return t;
    return null;
  })() ||
    (function (e, t) {
    ...
    Le && (i("consent", "default", Le), je(void 0)),
    i("js", new Date());
  const h =
    null !== (s = null == o ? void 0 : o.config) && void 0 !== s
      ? s
      : {};
  return (
    (h.origin = "firebase"),
...
function He(e) {
  ...
  e.dataLayerName && (Fe = e.dataLayerName),
...
function qe(e, t, n) {
  !(function () {
    ...
    if (
      ...
      const t = e.map((e, t) => `(${t + 1}) ${e}`).join(" "),
        n = be.create("invalid-analytics-context", { errorInfo: t });
      ye.warn(n.message);
    }
  })();
  ...
  if (null != Me[a]) throw be.create("already-exists", { id: a });
  if (!Re) {
    !(function (e) {
      let t = [];
      Array.isArray(window[e]) ? (t = window[e]) : (window[e] = t);
    })(Fe);
    const { wrappedGtag: e, gtagCore: t } = (function (
      e,
      t,
      n,
      a,
...
function Ze(e, t, n, a) {
  (e = v(e)),
    ...
    })(Ne, Me[e.app.options.appId], t, n, a).catch((e) =>
      ye.error(e)
    );
}
function Qe(e) {
    ...
    new I(
      ...
      function (e) {
        try {
          ...
          return { logEvent: (e, n, a) => Ze(t, e, n, a) };
        } catch (e) {
...
export {
  ze as getAnalytics,
  Ve as initializeAnalytics,
  Ke as isSupported,
  Ze as logEvent,
  Je as setAnalyticsCollectionEnabled,
  Qe as setConsent,
  We as setCurrentScreen,
  Ye as setDefaultEventParameters,
  Ge as setUserId,
  Ue as setUserProperties,
  He as settings,
};
